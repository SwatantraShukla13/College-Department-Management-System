...
<head>
	<meta charset="utf-8"> 
	<title>Manage Non Teaching staff Record</title>
...
<body>
  ...
  <div class="srch" style="padding-left:900px;">
        <form class="navbar-form" method="post" name="form1">
			<input class="form-control" type="text" name="search" placeholder="Staff Name.." >
	...
	<!--<table width="90%" height="40" style="margin: 92px; border:2px solid white;margin-top:auto" >
		...
		<?php
			...
			{			
				$q=mysqli_query($db,"SELECT * FROM `non_teach_staff` WHERE ");
			...
			{
				$res=mysqli_query($db,"SELECT * FROM `non_teach_staff` ; ");
				echo "<table class='table table-bordered table-hover'>";
				echo "<tr style='background-color:#208eec;'>";
				// table header
