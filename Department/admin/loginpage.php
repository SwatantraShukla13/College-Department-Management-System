		    ...
		    <h1><em>Department Management System</em></h1>
				...
				<form method="post" action="" name="login">
					...
					<label id="userlbl">User ID</label>
  					<input type="text" name="username" id="userId" placeholder="Enter Your Id"/><br><br>
					</span>
					<span id="pwd">
...
<?php
        ...
        {
            $count=0;
            $res=mysqli_query($db,"SELECT * FROM `user`where username='$_POST[username]' and password='$_POST[password]';");
